...
<%--  <a href="">首页</a>--%>
    <a href="menu/list/tree/children/page?id=${id}">子菜单管理</a>
    <a >子菜单列表</a>
</span>
...
<%--${page}--%>
    ...
    <script type="text/html" id="btns">
        <shiro:hasPermission name="permission:update">
            <a lay-event="edit" href="menu/edit/child/page?id={{d.id}}" class="layui-btn layui-btn-warm layui-btn-xs">修改</a>
        </shiro:hasPermission>
...
<%--            </div>--%>
            <div class="layui-inline">
                ...
                <shiro:hasPermission name="permission:insert">
                    <a href="menu/add/child/page?pid=${id}" class="layui-btn layui-btn-sm" lay-event="add">添加</a>
                </shiro:hasPermission>
            </div>
        </form>
    </script>
    <script type="text/javascript">
        ...
        layui.use('table', function(){
            ...
            let t = table.render({
                elem: '#table',
                height: 'full-60',
                url: 'menu/list/tree/children?id=${id}', //数据接口
                page: true, //开启分页
                limit:10,
                limits:[10,20,30,50],
                autoSort:false,
            ...
            table.on('tool(test)',function(obj){
                ...
                if(obj.event == 'del'){
                    layer.confirm('正在删除',{
                        ...
                        console.log('confirm')
                        location.href = '<%=basePath%>menu/child/delete?id='+id+'&pid=${id}'
                        layer.close(index)
                    })
                }
            })
