...
<form class="layui-form" action="user/edit" lay-filter="form" method="post">
        ...
        <div class="layui-input-block">
            <select
                ...
                <c:forEach items="${roleList}" var="role" >
                    <option value="${role.id}" ${formData.roleId==role.id?'selected':''}>${role.roleName}</option>
                </c:forEach>
            </select>
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="remark"
                      placeholder="请输入备注"
                      class="layui-textarea"> ${formData.remark}</textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
