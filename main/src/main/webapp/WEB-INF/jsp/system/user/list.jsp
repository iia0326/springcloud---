...
<%--${page}--%>
    ...
    <script type="text/html" id="btns">
        <shiro:hasPermission name="permission:update">
            <a lay-event="edit" href="user/edit/page?id={{d.id}}" class="layui-btn layui-btn-warm layui-btn-xs">修改</a>
        </shiro:hasPermission>
        ...
        <form class="layui-form " id="queryForm" lay-filter="queryFrom">
            ...
            <div class="layui-inline">
                ...
                <shiro:hasPermission name="permission:insert">
                    <a href="user/add/page" class="layui-btn layui-btn-sm" lay-event="add">添加</a>
                </shiro:hasPermission>
        ...
        layui.use('table', function(){
            ...
            let t = table.render({
                ...
                cols: [[ //表头
                    ...
                    {field: 'insertTime', title: '创建时间', width: 177,sort:true},
            ...
            table.on('tool(test)',function(obj){
                ...
                if(obj.event == 'del'){
                    layer.confirm('正在删除',{
                        ...
                        console.log('confirm')
                        location.href = '<%=basePath%>user/delete?id='+id
                        layer.close(index)
                    })
                }
            })
